...
//        Resource resource =resourceLoader.getResource("classpath:FutureGDP.csv");
        BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Aaron\\Documents\\SoftwareClasses\\hackathons\\gdp_predictor\\backend\\src\\main\\resources\\FutureGDP.csv"));
        try{
            String line;
